...
# Application
title = AYED NETWORK MASTER PRO
package.name = ayednetmaster
package.domain = pro.ayedoraybi.netmaster
...
# Branding (icon.png + presplash.png are generated by the CI workflow)
