...
**Generated:** 2026-06-01 01:48:53  
**Target:** ehub.ejada.com  
**Scan folder:** `ehub.ejada.com_20260601_013849`
...
#### [CRITICAL] SCORECARD-001: Attack Surface Scorecard — Risk Score 929/500 (100%) — CRITICAL
**CWE:** CWE-693 | **CVSS:** 0.0 | **Category:** Risk Scorecard

Attack Surface Scorecard — ehub.ejada.com
══════════════════════════════════════════════════
Risk Score    : 929 / 500 (100%)
Risk Band     : CRITICAL — Immediate remediation required
...
**Evidence:**
```
Total findings: 107 | Weighted score: 929/500
```
...
url: https://ehub.ejada.com?url=http%3A//url.ehub.ejada.com.YOUR_OOB_DOMAIN.burpcolla
...
dest: https://ehub.ejada.com?dest=http%3A//dest.ehub.ejada.com.YOUR_OOB_DOMAIN.burpcol
src: https://ehub.ejada.com?src=http%3A//src.ehub.ejada.com.YOUR_OOB_DOMAIN.burpcolla
...
CN=? | Issuer=? | Expires=?
SHA-256: b90d82084a32ffb657ef17183c3fa37b34b2b9126a2daf16fa42b7a4e292f437
SHA-1: 5520df9734f18447c5ba953ff17a03f89e421a88
...
#### [INFO] FINAL-CHAIN-REPORT-001: Final Attack Chain Report — 21C / 33H / 41M
**CWE:** CWE-693 | **CVSS:** 0.0 | **Category:** Report

═══ APEX_HUNTER FINAL REPORT — ehub.ejada.com ═══
Scan date    : 2026-06-01 01:47
Total findings: 114
Risk breakdown: CRITICAL=21 | HIGH=33 | MEDIUM=41 | LOW=0 | INFO=19
...
ATTACK CATEGORIES:
  ...
  Auth / Credential Stuffing                24 finding(s)
...
**Evidence:**
```
Total: 114 findings across 23 categories
```
