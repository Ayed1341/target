...
// (see README) to sign release builds. If absent, release falls back to the debug key
// so the project always builds.
...
android {
    namespace = "com.ayed.visionai.lite"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.ayed.visionai.lite"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
