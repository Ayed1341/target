...
export default function App() {
  ...
  const [settings, setSettings] = useState(() => {
    ...
    const savedModel = localStorage.getItem("aiv_gemini_model") || "gemini-3.5-flash";
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 md:p-5 flex flex-col gap-4 shadow-2xl animate-in fade-in slide-in-from-top duration-300" dir="rtl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                >
                  <option value="gemini-2.5-flash">Gemini 2.5 Flash (الأساسي - الأسرع للأجهزة)</option>
                  <option value="qwen-2.5-72b">Qwen 2.5 Instruct (Alibaba كيوين - مجاني مدمج)</option>
                  <option value="kimi-chat-v1">Kimi Chat Ultra (Moonshot كيمي - مجاني للترجمة)</option>
                  <option value="claude-3-haiku">Claude 3 Haiku (Anthropic كلاود هايكو - مجاني سريع)</option>
                  <option value="deepseek-v3">DeepSeek V3 (ديب سيك - مجاني فائق الاستدلال)</option>
                  <option value="gemini-2.5-pro">Gemini 2.5 Pro (التحليل البصري العالي - مجهري)</option>
