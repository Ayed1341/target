...
echo '=============================================================='
echo '[CRITICAL] SCORECARD-001'
echo 'Attack Surface Scorecard — Risk Score 919/500 (100%) — CRITICAL'
echo 'CWE: CWE-693  CVSS: 0.0  Category: Risk Scorecard'
echo '=============================================================='
cat <<'APEX_EOF'
# This is a summary scorecard — see individual findings for PoC commands
...
echo '=============================================================='
echo '[CRITICAL] P17c-HTTP-SMUGGLING-001'
echo 'HTTP Request Smuggling CONFIRMED — CL.TE/TE.CL Desync'
echo 'CWE: CWE-444  CVSS: 9.8  Category: HTTP Desync'
echo '=============================================================='
cat <<'APEX_EOF'
...
echo '=============================================================='
echo '[HIGH] P17b-JNDI-INJECT-001'
echo 'JNDI Header Injection (Log4Shell) — 0 error(s) triggered'
echo 'CWE: CWE-917  CVSS: 9.0  Category: Remote Code Execution'
echo '=============================================================='
cat <<'APEX_EOF'
...
echo '=============================================================='
echo '[HIGH] P17b-OAUTH2-STATE-CSRF-001'
echo 'OAuth2 Missing State Validation — CSRF Account Linking'
echo 'CWE: CWE-352  CVSS: 8.1  Category: OAuth / CSRF'
echo '=============================================================='
cat <<'APEX_EOF'
...
echo '=============================================================='
echo '[HIGH] P17b-OBJ-STORAGE-ACL-001'
echo 'Insecure Object Storage: 1 public bucket(s), 0 writable'
echo 'CWE: CWE-284  CVSS: 7.5  Category: Cloud Misconfiguration'
echo '=============================================================='
cat <<'APEX_EOF'
...
echo '=============================================================='
echo '[MEDIUM] P17b-UA-LOG-INJECT-001'
echo 'User-Agent Log Injection — CRLF/SIEM Log Forging Vector'
echo 'CWE: CWE-117  CVSS: 5.4  Category: Log Injection'
echo '=============================================================='
cat <<'APEX_EOF'
...
echo '=============================================================='
echo '[MEDIUM] P17b-ADMIN-PANEL-001'
echo 'Admin Panel Exposed — 37 path(s) found'
echo 'CWE: CWE-284  CVSS: 5.3  Category: Misconfiguration'
echo '=============================================================='
cat <<'APEX_EOF'
...
echo '=============================================================='
echo '[MEDIUM] P17c-CSWSH-001'
echo 'Cross-Site WebSocket Hijacking [UNVERIFIED]'
echo 'CWE: CWE-346  CVSS: 5.4  Category: WebSocket Security'
echo '=============================================================='
cat <<'APEX_EOF'
...
echo 'Final Attack Chain Report — 21C / 32H / 41M'
